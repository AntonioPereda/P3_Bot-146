...
enemy smallest fleet -> attack
x,y plane, calculate distance

if nearby small ally planet targeted -> reinforces weak planet (determined by if distance <= avg distance)

manipulate how many troops to send
    - send troops proportional to dist & planet growth rate
